...
import { OPPORTUNITIES } from '../data/constants.ts';
import type { Opportunity } from '../data/constants.ts';
import SwipeCard from '../components/SwipeCard.tsx';
import Confetti from '../components/Confetti.tsx';

interface SwipeScreenProps {
    onMatch: (match: Opportunity) => void;
}

export default function SwipeScreen({ onMatch }: SwipeScreenProps) {
    const [cards, setCards] = useState<Opportunity[]>([...OPPORTUNITIES]);
    const [matchCard, setMatchCard] = useState<Opportunity | null>(null);
