...
export default function SwipeCard({ opp, onPass, onInterest }: SwipeCardProps) {
    ...
    const handleStart = (e: React.MouseEvent | React.TouchEvent) => setStartX(getClientX(e));
